...
export default async function ComponentsReferencePage() {
  const t = await getTranslations("docs.components");
  ...
  return (
    <Stack gap="xl" maw={860}>
      <Stack gap="md">
        ...
        <DocsFigure id="staff-component-reference" />
      </Stack>
      ...
      <Stack gap="sm">
        ...
        <LinkAnchor href={staffComponentTypePath("repeatable-group")} size="sm">
          {t("repeatableLink")}
        </LinkAnchor>
      </Stack>
